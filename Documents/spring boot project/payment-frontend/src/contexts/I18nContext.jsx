...
const messages = {
  vi: {
    ...
    'export.xlsx': 'Xuất XLSX', 'export.csv': 'Xuất CSV', 'export.pdf': 'Xuất PDF', 'export.statement': 'Xuất sao kê', 'export.postingLegs': 'Xuất bút toán', 'export.failed': 'Không thể xuất file. Vui lòng thử lại.', 'export.format': 'Định dạng', 'export.includePostingLegs': 'Bao gồm bút toán', 'export.dateRequired': 'Vui lòng chọn từ ngày và đến ngày trước khi xuất sao kê.',
